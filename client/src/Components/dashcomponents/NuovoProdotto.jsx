  ...
  console.log(today)
    ...
    const handleSubmit = async (e) =>{
      ...
      const handleUpload = () =>{
        ...
        axios.post(`http://localhost:8080/upload/images`, formdata)
        ...
        <div className="d-flex justify-content-center align-items-center py-5">
          <div className={"p-3 rounded w-100 " + bgType + textType}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className="btn btn-danger w-100 rounded-0 mt-3" onClick={()=>setimmagine(e.target.files[0])}>
                Inserisci
              </button>
